...
uts46_map(CP) when 2194 =< CP, CP =< 2199 -> 'X';
...
uts46_map(CP) when 3163 =< CP, CP =< 3164 -> 'X';
...
uts46_map(CP) when 3287 =< CP, CP =< 3292 -> 'X';
...
uts46_map(CP) when 6863 =< CP, CP =< 6911 -> 'X';
uts46_map(CP) when 6912 =< CP, CP =< 6987 -> 'V';
uts46_map(CP) when 6989 =< CP, CP =< 6991 -> 'X';
...
uts46_map(CP) when 8385 =< CP, CP =< 8399 -> 'X';
...
uts46_map(CP) when 42955 =< CP, CP =< 42959 -> 'X';
uts46_map(CP) when 42970 =< CP, CP =< 42993 -> 'X';
...
uts46_map(CP) when 64451 =< CP, CP =< 64466 -> 'X';
...
uts46_map(CP) when 64968 =< CP, CP =< 64974 -> 'X';
...
uts46_map(CP) when 67005 =< CP, CP =< 67071 -> 'X';
...
uts46_map(CP) when 101641 =< CP, CP =< 110575 -> 'X';
...
uts46_map(CP) when 110883 =< CP, CP =< 110927 -> 'X';
...
uts46_map(CP) when 113828 =< CP, CP =< 118527 -> 'X';
...
uts46_map(CP) when 122655 =< CP, CP =< 122879 -> 'X';
...
uts46_map(CP) when 123648 =< CP, CP =< 124895 -> 'X';
...
uts46_map(CP) when 128728 =< CP, CP =< 128732 -> 'X';
...
uts46_map(CP) when 177977 =< CP, CP =< 177983 -> 'X';
